...
public class ClientConfig implements ConfigCore {
    ...
    @Config(description = {
            "Maximum time in ticks it takes to switch the lock on a slot.",
            "Set to zero to switch the lock instantly like a normal key press."
    })
    ...
    public boolean switchLockInstantly() {
        return this.triggerLockTicks < 1;
    }
}
